...
// register Education_Zone_Popular_Post widget
function education_zone_register_popular_post_widget() {
    register_widget( 'Education_Zone_Popular_Post' );
}
add_action( 'widgets_init', 'education_zone_register_popular_post_widget' );
...
class Education_Zone_Popular_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'education_zone_popular_post', // Base ID
			__( 'RARA: Popular Post', 'education-zone' ), // Name
			array( 'description' => __( 'A Popular Post Widget', 'education-zone' ), ) // Args
		);
	}
...
} // class Education_Zone_Popular_Post